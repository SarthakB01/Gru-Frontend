...
export default function Home() {
  ...
  // Mock testimonials with expanded content
  const testimonials = [
    {
      name: "Alex K.",
      role: "Computer Science Student",
      text: "Gru helped me prepare for my finals in half the time! The interactive quizzes made retaining complex algorithms so much easier.",
    ...
    },
    {
      name: "Jamie L.",
      role: "Biology Major",
      text: "Converting my lecture notes into interactive quizzes made studying so much more engaging. I've improved my grades by 15% this semester!",
      avatar: "/api/placeholder/56/56",
      rating: 4
    },
    {
      ...
      text: "The AI actually understands the context of my questions and provides relevant answers. It's like having a personal tutor available 24/7.",
      avatar: "/api/placeholder/56/56",
      rating: 5
    },
    {
      ...
      text: "Gru has transformed how I study complex medical terminologies and concepts. The quiz generation is surprisingly accurate.",
      avatar: "/api/placeholder/56/56",
      rating: 3
    }
  ];
  ...
  const features = [
    {
      icon: <FileText className="w-10 h-10 mb-4 text-indigo-500 dark:text-indigo-400" />,
      title: "Smart Document Analysis",
      description: "Upload your notes and Gru will analyze them instantly, identifying key concepts and relationships between topics."
    },
    {
      icon: <Brain className="w-10 h-10 mb-4 text-purple-500 dark:text-purple-400" />,
      title: "Adaptive Quizzes",
      description: "Generate personalized quizzes based on your content that adapt to your learning pace and focus on areas needing improvement."
    },
    {
      icon: <Sparkles className="w-10 h-10 mb-4 text-blue-500 dark:text-blue-400" />,
      title: "Contextual AI Chat",
      description: "Ask questions about your notes and get instant, contextually relevant answers that help deepen your understanding."
    }
  ];

  // Statistics with slight rewording
  const stats = [
    { value: "70%", label: "Students struggle with inefficient study methods" },
    { value: "3x", label: "Higher retention with interactive learning approaches" },
    { value: "45%", label: "Reduced study stress reported by Gru users" }
  ];

  // Problems with enhanced descriptions
  const problems = [
    {
      icon: <Clock className="w-12 h-12 mb-4 text-rose-500 dark:text-rose-400" />,
      title: "Overwhelming Study Workload",
      description: "Students are buried under mountains of notes, struggling to organize and review them effectively before exams."
    },
    {
      icon: <BookOpen className="w-12 h-12 mb-4 text-amber-500 dark:text-amber-400" />,
      title: "Poor Information Retention",
      description: "Despite hours spent studying, many students find they retain only a fraction of the material due to passive learning methods."
    },
    {
      icon: <X className="w-12 h-12 mb-4 text-red-500 dark:text-red-400" />,
      title: "Study Burnout & Anxiety",
      description: "Ineffective study approaches lead to frustration, anxiety before exams, and feeling perpetually unprepared despite the effort."
    }
  ];
  ...
  const FileUploader = ({ onUpload }) => {
    ...
    return (
      <div
        ...
        onDrop={handleDrop}
        className={`p-8 border-2 border-dashed rounded-xl cursor-pointer transition-all duration-300 flex flex-col items-center justify-center ${isDragging
          ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20'
          : 'border-gray-300 dark:border-zinc-600 hover:border-indigo-400 dark:hover:border-indigo-400'
          }`}
      >
        <FileUp size={40} className="text-indigo-500 dark:text-indigo-400 mb-4" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-zinc-900 dark:to-black text-gray-900 dark:text-gray-100">
      ...
      {/* Navbar */}
      <nav className={`sticky top-0 z-50 w-full transition-all duration-300 ${scrollY > 10
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <button className="ml-4 px-5 py-2.5 rounded-full shadow-md text-sm font-medium text-white bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition-all duration-300 hover:scale-105">
                Login
              </button>
          ...
          <div className="md:hidden border-t border-gray-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm">
            <div className="pt-2 pb-3 space-y-1 px-4">
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-zinc-700">
                <button className="px-4 py-2 rounded-full shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Login
                </button>
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="rounded-xl bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 shadow-xl border border-gray-200 dark:border-zinc-700 overflow-hidden max-w-4xl mx-auto transform transition-all duration-500 hover:scale-[1.02]">
            ...
            <div className="p-4">
              <img src="/api/placeholder/700/400" alt="Gru AI Interface" className="rounded-lg border border-gray-200 dark:border-zinc-600 shadow-md" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white dark:from-zinc-900 dark:to-zinc-800">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">The Problem</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Most students struggle with inefficient study methods. Overwhelmed by information, they face low retention, stress, and burnout with traditional approaches.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6 text-center">
            {stats.map((stat, index) => (
              <div key={index} className="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-zinc-700 transform transition-all duration-300 hover:scale-105">
                <p className="text-5xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">{stat.value}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {problems.map((problem, index) => (
              <ProblemCard key={index} icon={problem.icon} title={problem.title} description={problem.description} />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* Solution Section */}
      <section id="solution" className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-zinc-800 dark:to-zinc-900 rounded-tl-3xl rounded-tr-3xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              <div className="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-zinc-700 h-full transform transition-all duration-300 hover:shadow-lg">
                <img src="/api/placeholder/400/300" alt="Student studying with Gru" className="rounded-lg w-full object-cover mb-6 shadow-md" />
                <h3 className="text-2xl font-semibold mb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">How Gru Works</h3>
            ...
            <div className="md:w-1/2">
              <div className="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-zinc-700 h-full flex flex-col justify-center transform transition-all duration-300 hover:shadow-lg">
                <h3 className="text-2xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">Transform Your Study Experience</h3><ul className="space-y-5">
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-700 dark:text-gray-200">Upload any PDF or DOCX files with your lecture notes or textbooks</span>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-1.5 rounded-full mr-3 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700 dark:text-gray-200">Gru AI analyzes content to identify key concepts and knowledge gaps</span>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-1.5 rounded-full mr-3 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700 dark:text-gray-200">Generate customized quizzes that adapt to your learning progress</span>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-1.5 rounded-full mr-3 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700 dark:text-gray-200">Focus on areas where you need improvement using intelligent spaced repetition</span>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-1.5 rounded-full mr-3 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700 dark:text-gray-200">Ask questions about your content and get contextually relevant answers</span>
                  </li>
                </ul>
      ...
      <section id="features" className="py-20 bg-white dark:bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">Key Features</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Gru is designed to revolutionize how you study, making learning efficient, engaging, and effective.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-zinc-800 dark:to-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">What Students Say</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Real students share their experiences with Gru and how it transformed their study habits.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {testimonials.map((testimonial, index) => (
                <TestimonialCard
                  ...
                  isActive={index === activeTestimonialIndex || index === (activeTestimonialIndex + 1) % testimonials.length}
                />
              ))}
            </div>
      ...
      <section id="demo" className="py-20 bg-white dark:bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">Try Gru Yourself</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Upload a sample document to see how Gru can transform your study materials into an interactive learning experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-zinc-700">
              <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Upload Your Document</h3>
              {!fileUploaded ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">File Uploaded Successfully!</h4>
                  <p className="text-gray-500 dark:text-gray-400 mb-4">Your document is being processed by Gru AI.</p>
                  <button
              ...
              <div className="mt-6">
                <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-3">What happens next?</h4>
                <ol className="space-y-3 text-gray-600 dark:text-gray-300">
                  <li className="flex">
                    <span className="mr-2 font-bold">1.</span>
                    <span>Gru analyzes your document to extract key concepts and relationships</span>
                  </li>
                  <li className="flex">
                    <span className="mr-2 font-bold">2.</span>
                    <span>Generates customized quizzes based on the content</span>
                  </li>
                  <li className="flex">
                    <span className="mr-2 font-bold">3.</span>
                    <span>Creates an interactive study environment for maximum retention</span>
                  </li>
                </ol>
              </div>
            </div>
              ...
              <Tabs.Root defaultValue="quiz" className="w-full">
                ...
                <Tabs.Content value="quiz" className="outline-none">
                  <div className="border border-gray-200 dark:border-zinc-700 rounded-lg overflow-hidden shadow-md">
                    <div className="bg-gray-50 dark:bg-zinc-800 px-4 py-3 border-b border-gray-200 dark:border-zinc-700">
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">Biology Quiz - Cell Structure</h3>
                    </div>
                    <div className="p-4 bg-white dark:bg-zinc-900">
                      <div className="mb-6">
                        <p className="text-gray-800 dark:text-gray-200 mb-3">What is the primary function of mitochondria in eukaryotic cells?</p>
                        <div className="space-y-2">
                          <div className="flex items-center">
                            <input type="radio" id="option1" name="answer" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-zinc-600" />
                            <label htmlFor="option1" className="ml-2 text-gray-700 dark:text-gray-300">Protein synthesis</label>
                          </div>
                          <div className="flex items-center">
                            <input type="radio" id="option2" name="answer" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-zinc-600" />
                            <label htmlFor="option2" className="ml-2 text-gray-700 dark:text-gray-300">Energy production (ATP)</label>
                          </div>
                          <div className="flex items-center">
                            <input type="radio" id="option3" name="answer" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-zinc-600" />
                            <label htmlFor="option3" className="ml-2 text-gray-700 dark:text-gray-300">Lipid storage</label>
                          </div>
                          <div className="flex items-center">
                            <input type="radio" id="option4" name="answer" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-zinc-600" />
                            <label htmlFor="option4" className="ml-2 text-gray-700 dark:text-gray-300">DNA replication</label>
                          </div>
                        </div>
                      </div>
                ...
                <Tabs.Content value="chat" className="outline-none">
                  <div className="border border-gray-200 dark:border-zinc-700 rounded-lg overflow-hidden shadow-md h-80 flex flex-col">
                    <div className="bg-gray-50 dark:bg-zinc-800 px-4 py-3 border-b border-gray-200 dark:border-zinc-700">
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">Ask about your content</h3>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start">
                          <div className="bg-indigo-100 dark:bg-indigo-900/30 rounded-lg p-3 max-w-[80%]">
                            <p className="text-gray-800 dark:text-gray-200">Hi there! I've analyzed your Biology notes. What would you like to know about cell structures?</p>
                          </div>
                        </div>
                        <div className="flex items-start justify-end">
                          <div className="bg-gray-100 dark:bg-zinc-800 rounded-lg p-3 max-w-[80%]">
                            <p className="text-gray-800 dark:text-gray-200">Can you explain the difference between mitochondria and chloroplasts?</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <div className="bg-indigo-100 dark:bg-indigo-900/30 rounded-lg p-3 max-w-[80%]">
                            <p className="text-gray-800 dark:text-gray-200">Based on your notes: Mitochondria and chloroplasts are both organelles in eukaryotic cells, but they serve different functions. Mitochondria are present in almost all eukaryotic cells and produce energy through cellular respiration. Chloroplasts are found in plant cells and some algae and conduct photosynthesis to convert light into chemical energy.</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Ready to Transform Your Study Habits?</h2>
          <p className="text-xl text-indigo-100 mb-8 max-w-3xl mx-auto">
            Join thousands of students who have already revolutionized their learning process with Gru's AI-powered study tools.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center md:space-x-8 mb-6 md:mb-0">
              <a href="#" className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Features</a>
              <a href="#" className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Pricing</a>
              <a href="#" className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">About</a>
              <a href="#" className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Contact</a>
              <a href="#" className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Blog</a>
            </div>
          ...
          <div className="border-t border-gray-200 dark:border-zinc-700 pt-6 mt-8">
            <p className="text-center text-gray-500 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Gru Learning, Inc. All rights reserved.
            </p>
